    ...
    <body>
          ...
          <ul class="cb-slideshow">
           ...
           <!--/ Codrops top bar -->
            ...
            <br><br><br>
           <form action="changeclass" method="get">
                <div class="container">
                <div class="col-md-offset-2 col-md-5">
                    <div class="form-group">
                        <!--<label style="border-radius: 5px;background-color: black ;font-weight: bold;font-size: 20px;color: #FFFFFF" for="productname">edit by flight ID</label>-->
                        
                        <input type="text" placeholder="flight's ID" class="form-control"  name="flightid" required>
                    </div>
                    
                     <div class="form-group">
                         <label style="border-radius: 5px;background-color: black ;font-weight: bold;font-size: 20px;color: #FFFFFF" for="productname">select new class</label>
                    ...
                    <button type="submit"  id="login-button" name="submit" >change</button>
                </div>
            </div>
            </form>  

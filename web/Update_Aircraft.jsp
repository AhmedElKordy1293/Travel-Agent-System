...
<html>
    ...
    <body>
        ...
        <div class="codrops-top">
           ...
           <!--/ Codrops top bar -->
            <header>
                <img id="test" style="float:left ;display:inline-block;height:100px;width:280px" src="images/12355894_971761582870861_504423863_o.png" />
            ...
            <form action="Update_Aircraft1.jsp" method="get">
                <div class="container">
                <div class="col-md-offset-2 col-md-5">
                    <div class="form-group">
                        <label style="border-radius: 5px;background-color: black ;font-weight: bold;font-size: 20px;color: #FFFFFF" for="productname">search aircraft want to update</label>
                        <input type="text" placeholder="aircraft's ID" class="form-control"  name="aircraftid" required>
                    </div>
                    <button type="submit"  id="login-button" name="submit" >search</button>
                </div>
            </div>
            </form>                       
    </body>

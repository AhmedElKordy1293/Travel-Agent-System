                ...
                <center><div style="height: 80px"></div> </center>
                    ...
                    <p style="padding-left: 30px" class="codrops-demos">
                        <a style="font-size: 20px" href="profile.jsp" >Edit profile</a>
                                ...
                                <a style="font-size: 20px" href="Update_Fligth.jsp">Update flight</a>
				</p>
                                
        </div>
            
            <form action="Update_Flight1.jsp" method="get">
                <div class="container">
                <div class="col-md-offset-2 col-md-5">
                    <div class="form-group">
                        <label style="border-radius: 5px;background-color: black ;font-weight: bold;font-size: 20px;color: #FFFFFF" for="productname">search flight want to update</label>

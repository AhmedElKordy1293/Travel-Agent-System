    ...
    <body>
          ...
          <ul class="cb-slideshow">
           ...
           <!--/ Codrops top bar -->
            ...
            <br><br><br>
           <form action="checkbfid" method="get">
                <div class="container">
                <div class="col-md-offset-2 col-md-5">
                    <div class="form-group">
                        <label style="border-radius: 5px;background-color: black ;font-weight: bold;font-size: 20px;color: #FFFFFF" for="productname">Book by flight ID</label>
